...
const audio = new Audio('https://h.top4top.io/m_32630iyxt1.mp3');
audio.play();
reject("Link Eror❌️, Masukan Link Yang Benar");
}
});
}
async function downloadVideo() {       
  ...
  window.location.href = "https://www.situsyanginginituju.com";
}
